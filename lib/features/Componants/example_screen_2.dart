...
class VRmodel extends StatefulWidget {
  const VRmodel({super.key, required this.title, required this.url});
  final String title;
  final String url;
  @override
  VRmodelState createState() => VRmodelState(this.title,  this.url);
}

class VRmodelState extends State<VRmodel> {
 final String title;
  final String url;

  VRmodelState(this.title,  this.url);


  late final WebViewController _controller;

  var placeurl = "https://www.google.com";
